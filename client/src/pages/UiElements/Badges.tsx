...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Event Management - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for Event Management - React.js Tailwind CSS Admin Dashboard Template"
      />
