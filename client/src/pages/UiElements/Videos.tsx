...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Event Management - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Event Management - React.js Tailwind CSS Admin Dashboard Template"
      />
