...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Event Management - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Event Management - React.js Tailwind CSS Admin Dashboard Template"
      />
